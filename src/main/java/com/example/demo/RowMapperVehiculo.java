...
public class RowMapperVehiculo implements RowMapper<Vehiculo> {
	...
	// rs.getLong("idVehiculo") coge el valor de la columna "idVehiculo" de esa fila.
	// Los nombres entre comillas tienen que coincidir EXACTAMENTE con las columnas de la BD.
